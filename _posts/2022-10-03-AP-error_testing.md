...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="kn">from</span> <span class="nn">logging.handlers</span> <span class="kn">import</span> <span class="n">BufferingHandler</span>

<span class="c1"># this is my info db</span>
<span class="n">menu</span> <span class="o">=</span>  <span class="p">{</span><span class="s2">&quot;burger&quot;</span><span class="p">:</span> <span class="mf">3.99</span><span class="p">,</span>
         ...
         <span class="s2">&quot;shake&quot;</span><span class="p">:</span> <span class="mf">2.50</span><span class="p">,</span>
         <span class="s2">&quot;cookie&quot;</span><span class="p">:</span><span class="mf">0.99</span><span class="p">}</span>
...
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;your total will be&quot;</span><span class="p">)</span>  

<span class="c1"># Set sum Variable - total</span>
<span class="n">total</span> <span class="o">=</span> <span class="mi">0</span>

<span class="c1">#set list as l</span>
<span class="n">l</span> <span class="o">=</span> <span class="p">[]</span>

<span class="c1">#start while loop</span>
<span class="k">while</span> <span class="n">item</span> <span class="o">!=</span> <span class="s2">&quot;&quot;</span><span class="p">:</span>
    <span class="c1">#append is adding the items from the menu to my list l</span>
    ...
    <span class="c1">#sets item as a variable using the input that matches with the info db</span>
    <span class="n">item</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Please select an item from the menu, or click enter if you are done.&quot;</span><span class="p">)</span>
<span class="c1">#function that adds up the items you bought</span>
...
<span class="c1">#rounds total to 3 place values</span>
